    ...
    <div className="flex flex-col justify-center">
      ...
      <div>
        ...
        <div className="my-4">
          ...
          <h3 className="font-semibold text-h1 text-tblack">30-Days Trial Now!</h3>
          <p className="font-normal text-h2 text-tblack2 py-4">
            Experience why over 2 million customers choose Audease tools
          </p>
        </div>
        {/* Text 2  */}
        <div className="my-4">
          ...
          <div>
            ...
            <p className="font-normal text-h2 text-tblack2">No hidden charges, No credit card required</p>
          </div>
          <div>
            <Image
              src="/icon2.svg"
          ...
          <div className="">
            ...
            <p className="font-normal text-h2 text-tblack2">Enjoy the Free Trial with your company data</p>
          </div>
          <div>
            <Image
              src="/icon4.svg"
              ...
              alt="audease logo"
            ></Image>
            <h5 className="font-semibold text-tblack"> Unlimited Features </h5>
            <p className="font-normal text-h2 text-tblack2">Access all features all at once.</p>
          </div>
          </div>
        </div>
        {/* Text 3  */}
